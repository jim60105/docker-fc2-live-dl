...
# ffmpeg
COPY --link --from=ghcr.io/jim60105/static-ffmpeg-upx:8.1 /ffmpeg /usr/bin/
# COPY --link --from=ghcr.io/jim60105/static-ffmpeg-upx:8.1 /ffprobe /usr/bin/

# dumb-init
COPY --link --from=ghcr.io/jim60105/static-ffmpeg-upx:8.1 /dumb-init /usr/bin/
